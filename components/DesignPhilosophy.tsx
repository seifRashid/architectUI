...
export default function DesignPhilosophy() {
  return (
    <section className="py-24 md:py-40 bg-foreground text-background overflow-hidden border-b border-background/10">
        ...
        <div className="max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <ScrollReveal direction="up" delay={0.4}>
              <div className="text-lg md:text-xl font-light leading-relaxed text-background/70">
                <p className="mb-8">
